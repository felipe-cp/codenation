...
def main():
    # Parte visual com titulos e imagens 
    st.image('logo.png', width= 200)
    st.title('AceleraDev Data Science')
    st.subheader('Semana 2 - Pré-processamento de Dados em Python')
    file  = st.file_uploader('Escolha a base de dados que deseja analisar (.csv)', type = 'csv') # upload do arquivo
    if file is not None: # comando IF que só irá executar os comandos abaixo após o input do arquivo
...
# Interessante desse projeto foi aprender como podemos integrar de visualmente e de forma interativa aquilo que aprendemos no Jupyter Notebook
